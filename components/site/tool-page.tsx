      ...
      <section className="border-t border-line bg-paper-2/50">
        <div className="mx-auto max-w-4xl px-6 py-14">
          ...
          <StaggerGroup className="mt-6 grid gap-3 sm:grid-cols-3">
            {others.map(t => (
              <StaggerItem key={t.href} className="min-w-0">
                <Link
                  href={t.href}
                  className="panel group flex h-full flex-col p-5 transition-all hover:border-hound hover:shadow-[var(--shadow-panel)]"
                >
